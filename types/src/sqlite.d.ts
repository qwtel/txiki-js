...
declare module 'tjs:sqlite'{
    ...
    export class AsyncDatabase {
         ...
         */
        run(sql: string, params?: any[], options?: { signal?: AbortSignal }): Promise<void>;
         ...
         * Idempotent.
         *
         * Aliased as `Symbol.asyncDispose`, so `await using db = new AsyncDatabase(...)`
         * closes the database at scope exit after queued operations complete.
         */
        close(): void;
