...
const sqlite_funcs = [_]c.JSCFunctionListEntry{
    ...
    z.TJS_CONST("SQLITE_OPEN_CREATE", c.SQLITE_OPEN_CREATE),
    z.TJS_CONST("SQLITE_OPEN_READONLY", c.SQLITE_OPEN_READONLY),
    z.TJS_CONST("SQLITE_OPEN_READWRITE", c.SQLITE_OPEN_READWRITE),
};
